...
namespace ExMart_Backend.Migrations
{
    ...
    [Migration("20241226101645_newProductDataSeeding28")]
    partial class newProductDataSeeding28
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExMart_Backend.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 26, 10, 16, 45, 206, DateTimeKind.Utc).AddTicks(4390),
                            CreatedBy = 1,
                            Description = "Ergonomic wireless mouse with 2.4 GHz connectivity",
                            Name = "Wireless Mouse",
                            Price = 25m,
                            Size = new List<string> { "XS", "S", "M" },
                            UpdatedAt = new DateTime(2024, 12, 26, 10, 16, 45, 206, DateTimeKind.Utc).AddTicks(4393),
                            VendorId = 1,
                            Weight = 250m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 11, 22, 19, 7, 0, 0, DateTimeKind.Utc),
                            CreatedBy = 1,
                            Description = "Experion branded t-shirt",
                            Name = "Experion Tshirt",
                            Price = 1499.00m,
                            Size = new List<string> { "15.6 inches" },
                            UpdatedAt = new DateTime(2023, 11, 23, 20, 52, 0, 0, DateTimeKind.Utc),
                            VendorId = 1,
                            Weight = 500m
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Price = 149.99m,
                            Size = new List<string> { "Standard" },
                            UpdatedAt = new DateTime(2023, 11, 22, 19, 7, 0, 0, DateTimeKind.Utc),
                            VendorId = 1,
                            Weight = 200m
                        },
                        new
