    ...
    public partial class seedingUserTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "Email", "Name", "Phone" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 29, 15, 7, 43, 797, DateTimeKind.Utc).AddTicks(487), "johndoe@example.com", "John Doe", "1234567890" },
                    { 2, new DateTime(2024, 12, 29, 15, 7, 43, 797, DateTimeKind.Utc).AddTicks(513), "janesmith@example.com", "Jane Smith", "0987654321" },
                    { 3, new DateTime(2024, 12, 29, 15, 7, 43, 797, DateTimeKind.Utc).AddTicks(516), "alicebrown@example.com", "Alice Brown", "1122334455" }
                });
        }
