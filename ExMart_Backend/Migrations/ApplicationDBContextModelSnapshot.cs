...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExMart_Backend.Model.Order", b =>
                {
                    ...
                    b.Property<int?>("StatusMasterProduct_StatusId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StatusMasterProduct_StatusId");
            ...
            modelBuilder.Entity("ExMart_Backend.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 1, 5, 7, 38, 59, 831, DateTimeKind.Utc).AddTicks(5686),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 1, 5, 7, 38, 59, 831, DateTimeKind.Utc).AddTicks(5688),
            ...
            modelBuilder.Entity("ExMart_Backend.Model.Order", b =>
                {
                    b.HasOne("ExMart_Backend.Model.StatusMaster", null)
                        .WithMany("Orders")
                        .HasForeignKey("StatusMasterProduct_StatusId");
